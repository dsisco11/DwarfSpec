...
describe('immutable DwarfSpec contract enums', function()
    it('exposes stable string values directly', function()
        ...
        assert.equals('left_click', MouseInput.LEFT_CLICK)
        assert.equals('left_down', MouseInput.LEFT_DOWN)
        assert.equals('left_up', MouseInput.LEFT_UP)
        assert.equals('scroll_down', MouseInput.SCROLL_DOWN)
    ...
    it('rejects namespace mutation for every requested type', function()
        ...
        assert_immutable(MouseInput, 'LEFT_CLICK')
