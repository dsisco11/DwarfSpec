...
function Harness.new(options)
    ...
    local dependencies = {
        ...
        wait_frames=options.wait_frames or function() end,
        wait_ticks=options.wait_ticks or function() end,
        wait_event=options.wait_event or function() end,
        wait_until=options.wait_until or function() end,
