...
return immutable_enum.define({
    ...
    CLEANUP_TRANSACTION_REGISTERED='cleanup.transaction_registered',
    CLEANUP_TRANSACTION_STARTED='cleanup.transaction_started',
    CLEANUP_TRANSACTION_FINISHED='cleanup.transaction_finished',
    CLEANUP_TRANSACTION_ABANDONED='cleanup.transaction_abandoned',
