...
---@class dwarfspec.RegisterCleanupCommand
---@field private _options table
local RegisterCleanup = {}
RegisterCleanup.__index = RegisterCleanup
...
---Creates the command owner using run-scoped cleanup authorities.
---@param options table
---@return dwarfspec.RegisterCleanupCommand
function RegisterCleanup.new(options)
    ...
    return setmetatable({_options=options}, RegisterCleanup)
end

---Creates the privileged immutable cleanup definition.
---@return dwarfspec.CommandDefinition
function RegisterCleanup:definition()
...
---Adapts the public registerCleanup signature for the runner.
---@param registration table
---@param command_options? table
---@return table, table|nil
function RegisterCleanup:arguments(registration, command_options)
    return {registration=registration}, command_options
end
